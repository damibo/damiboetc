...
class Workstation(Installer):
   ...
   def InitializeInstall(self, old, new, upgrade):
      ...
      arch = self.GetManifestValue('architecture', None)
      if arch == 'x86':
         self.AddTarget('Link', DEST/'bin/appLoader', DEST/'bin/vmware-gdb-proxy')
         self.AddTarget('Link', DEST/'bin/appLoader', BINDIR/'vmware-gdb-proxy')
